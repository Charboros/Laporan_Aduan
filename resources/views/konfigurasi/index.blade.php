                ...
                <div class="p-6 border-b lg:border-b-0 lg:border-r border-slate-100 bg-slate-50/50 lg:w-1/3">
                    ...
                    <form action="{{ route('konfigurasi.user.store') }}" method="POST" class="space-y-4">
                        ...
                        <div>
                            ...
                            <input type="password" name="password" required class="w-full border-slate-200 rounded-xl text-sm">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-slate-700 mb-1">Konfirmasi Password</label>
                            <input type="password" name="password_confirmation" required class="w-full border-slate-200 rounded-xl text-sm">
                        </div>
                        <div class="pt-2">
